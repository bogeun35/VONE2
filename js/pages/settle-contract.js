...
(function () {
  ...
  const columnDefs = [
    ...
    { headerName: '거래처 IDX', field: 'partnerIdx', width: 44, cellRenderer: LinkRenderer, cellStyle: rightAlign, headerClass: 'header-right', context: { voneIsNumeric: true } },
    { headerName: '거래처명', field: 'partnerName', width: 108 },
    { headerName: '거래처 사업자번호', field: 'bizNo', width: 88, cellStyle: rightAlign, headerClass: 'header-right', context: { voneIsNumeric: true } },
    { headerName: '종사업장 번호', field: 'subBizNo', width: 60, cellStyle: rightAlign, headerClass: 'header-right' },
    { headerName: '그룹정산', field: 'isGroup', width: 56, cellRenderer: YNRenderer, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '연결 제휴점 수', field: 'shopCount', width: 68, cellStyle: rightAlign, headerClass: 'header-right', context: { voneIsNumeric: true } },
    { headerName: '제휴점 ID', field: 'shopId', width: 140, cellRenderer: ShopLinkRenderer },
    { headerName: '연결 제휴점명', field: 'shopName', width: 120 },
    { headerName: '정산 주기', field: 'cycleType', width: 60, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '정산주기일', field: 'cycleDay', width: 60, cellStyle: rightAlign, headerClass: 'header-right', context: { voneIsNumeric: true } },
    { headerName: '지급 주기', field: 'payCycle', width: 54, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '서비스 포인트 수수료율', field: 'pointFeeRate', width: 84, cellRenderer: PctRenderer, cellStyle: rightAlign, headerClass: 'header-right', context: { voneIsNumeric: true } },
    { headerName: '대장페이 수수료율', field: 'payFeeRate', width: 84, cellRenderer: PctRenderer, cellStyle: rightAlign, headerClass: 'header-right', context: { voneIsNumeric: true } },
    { headerName: '매입 증빙 수취 유형', field: 'proofType', width: 110 },
    { headerName: '연동사 타입', field: 'linkType', width: 68 },
    { headerName: '공동인증서 만료일', field: 'certExpire', width: 82, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '폐업일자', field: 'closedAt', width: 74, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '적격증빙상계', field: 'proofOffset', width: 78, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '이체상계', field: 'transferOffset', width: 64, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '정산 은행명', field: 'settleBank', width: 76 },
    { headerName: '정산 계좌번호', field: 'settleAccount', width: 108, cellStyle: rightAlign, headerClass: 'header-right' },
    { headerName: '정산 예금주', field: 'settleOwner', width: 100 },
    { headerName: '계약 시작일', field: 'startAt', width: 82, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '계약 종료일', field: 'endAt', width: 82, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '계약 해지일', field: 'terminatedAt', width: 82, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '연장검토', field: 'extReview', width: 58, cellRenderer: YNRenderer, cellStyle: centerAlign, headerClass: 'header-center' },
    { headerName: '상태', field: 'status', width: 54, pinned: 'right', cellRenderer: StatusRenderer, headerClass: 'header-center',
    ...
    { headerName: '수정자', field: 'updatedBy', width: 54 },
    ...
    { headerName: '정산서 보기', field: '_viewSettle', width: 82, cellRenderer: SettleBtnRenderer, pinned: 'right', sortable: false, filter: false, cellClass: 'cell-action-buttons' },
