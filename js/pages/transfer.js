...
const columnDefs = [
  ...
  { headerName: '이체예정금액', field: 'transferAmount', width: 84, minWidth: 70, cellRenderer: AmountRenderer, cellStyle: rightAlign, headerClass: 'header-right', filter: 'agNumberColumnFilter' },
